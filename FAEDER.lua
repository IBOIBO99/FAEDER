...
--     By Developer IBOIBO     -- 
if text and text:match('^ةنلنةاتراىبارلارتوةىن (.*)$')
...
--     By Developer IBOIBO     -- 
if text == "حذف الاوامر المضافه" or text == "مسح الاوامر المضافه"
local list = faederdx1:smembers(bot_id.."List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(list) do
...
--     By Developer IBOIBO     -- 
if text and text:match("^اضف صلاحيه (.*)$") 
...
--     By Developer IBOIBO     -- 
if text and text:match("^مسح صلاحيه (.*)$") or text and text:match("^حذف صلاحيه (.*)$") 
...
--     By Developer IBOIBO     -- 
if text and text:match("رفع (.*)") and tonumber(msg.reply_to_message_id_) > 0 
...
--     By Developer IBOIBO     -- 
if text and text:match("تنزيل (.*)") and tonumber(msg.reply_to_message_id_) > 0 
...
if text ==('تفعيل') and not is_admin(msg.sender_user_id_, msg.chat_id_) and not faederdx1:get(FAEDER..'lock:bot:free'..bot_id)
function adding(extra,result,success)
local function promote_admin(extra, result, success)
local num = 0
...
--     By Developer IBOIBO     --
if text and text:match("^احسب (.*)$") and faeder11(msg) or text and text:match("^عمري (.*)$") 
...
--     By Developer IBOIBO     -- 
if text and text:match("^برج (.*)$") and faeder11(msg)  or text and text:match("^برجي (.*)$") 
...
if text == 'بوت'  name_bot = (faederdx1:get('faeder:'..bot_id..'name_bot') or 'ايبو')  local faeder = {  "أسمي "..name_bot.." يعمري ",  "أسمي "..name_bot.." يقميل ",  "تره أسمي "..name_bot.." كافي بوت ",  "انت البوت لك اسمي "..name_bot.." ", }  faeder2 = math.random(#faeder) faederdx(msg.chat_id_, msg.id_, 1, faeder[faeder2] , 1, 'md')  end
...
--     By Developer IBOIBO     -- 
if text == 'محيبس' or text == 'بات' or text == 'المحيبس'
if faederdx1:get(FAEDER..'bot:lock_geam'..msg.chat_id_) then
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙الالعاب معطله من قبل الادمن \n⌯︙ارسل { تفعيل اللعبه } لتفعيلها ', 1, 'md')
return "faeder"
end
...
if text == 'خمن' and faeder11(msg) or text == 'تخمين'   
if faederdx1:get(FAEDER..'bot:lock_geam'..msg.chat_id_) then
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙الالعاب معطله من قبل الادمن \n⌯︙ارسل { تفعيل اللعبه } لتفعيلها ', 1, 'md')
return "faeder"
end
...
--     By Developer IBOIBO     -- 
if text == 'الالعاب' or text == 'اللعبه'
if faederdx1:get(FAEDER..'bot:lock_geam'..msg.chat_id_) then
...
--     By Developer IBOIBO     -- 
if text == "تعيين قناة الاشتراك" or text == "تغيير قناة الاشتراك"
...
--     By Developer IBOIBO     -- 
if text and text == "اهمس" or text and text == "همسه" or text and text == "اريد بوت الهمسه" or text and text == "دزلي بوت الهمسه" or  text and text == "دزولي بوت الهمسه"  
...
--     By Developer IBOIBO     -- 
if text == 'رفع المشرفين' or text == 'رفع الادمنيه'  
local function promote_admin(extra, result, success)  
local num = 0
local admins = result.members_  
for i=0 , #admins do   
...
--     By Developer IBOIBO     -- 
if text == 'كشف القيود' and tonumber(msg.reply_to_message_id_) > 0 and is_momod(msg.sender_user_id_, msg.chat_id_) 
...
if text and text:match('^كشف القيود @(.*)') and is_momod(msg.sender_user_id_, msg.chat_id_) 
...
if text == 'رفع القيود' and tonumber(msg.reply_to_message_id_) > 0 and is_momod(msg.sender_user_id_, msg.chat_id_) 
...
if text and text:match('^رفع القيود (%d+)') and Admin(msg) 
...
if text and text:match('^رفع القيود @(.*)') and is_momod(msg.sender_user_id_, msg.chat_id_)  
...
if text ==  ""..name_bot..' غادر'
chat_leave(msg.chat_id_, bot_id)
faederdx1:srem(FAEDER.."bot:groups",msg.chat_id_)
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم مغادره المجموعه وحذف بياناتها ، ', 1, 'md')
end end
--     By Developer IBOIBO     -- 
if text == 'تعطيل تنبيه الدخول' and is_owner(msg.sender_user_id_, msg.chat_id_)
...
--     By Developer IBOIBO     -- 
if text and text == 'تفعيل وضع حسابي' and is_owner(msg.sender_user_id_, msg.chat_id_)
...
if text and text == 'تعطيل وضع حسابي' and is_owner(msg.sender_user_id_, msg.chat_id_)
...
--     By Developer IBOIBO     -- 
if text and (text:match("^موقعي$") and faeder11(msg) or text:match("^رتبتي$"))
...
--     By Developer IBOIBO     -- 
if text:match("^الرتبه$") and msg.reply_to_message_id_ ~= 0
...
--     By Developer IBOIBO     -- 
if text == 'تعطيل اطردني' and is_owner(msg.sender_user_id_, msg.chat_id_)
if not faederdx1:get(FAEDER.."lock_kickme"..msg.chat_id_) then
faederdx1:set(FAEDER.."lock_kickme"..msg.chat_id_, true)
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم تعطيل امر اطردني ، ', 1, 'md')
end end
if text == 'تفعيل اطردني' and is_owner(msg.sender_user_id_, msg.chat_id_)
...
--     By Developer IBOIBO     -- 
if text == 'تعطيل نزلني' and is_monsh(msg.sender_user_id_, msg.chat_id_)
if not faederdx1:get(FAEDER.."lock_delme"..msg.chat_id_) then
faederdx1:set(FAEDER.."lock_delme"..msg.chat_id_, true)
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙اهلا عزيزي ، '..renk_faeder(msg)..' \n⌯︙تم تعطيل امر نزلني ،', 1, 'md')
end end
if text == 'تفعيل نزلني' and is_monsh(msg.sender_user_id_, msg.chat_id_)
...
--     By Developer IBOIBO     -- 
if text:match("^رسائلي$") and msg.reply_to_message_id_ == 0 
local user_msgs = faederdx1:get(FAEDER..'user:msgs'..msg.chat_id_..':'..msg.sender_user_id_)
local faeder = faederdx1:get(FAEDER..'user:msgs'..bot_id..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local faedery = (faederdx1:get('faeder:'..bot_id..'nummsg'..msg.chat_id_..msg.sender_user_id_) or 0)
...
--     By Developer IBOIBO     -- 
if text:match('^الحساب (%d+)$')
local id = text:match('^الحساب (%d+)$')
local text = 'اضغط لمشاهده العضو ⌯︙'
tdcli_function ({ID="SendMessage", chat_id_=msg.chat_id_, reply_to_message_id_=msg.id_, disable_notification_=0, from_background_=1, reply_markup_=nil, input_message_content_={ID="InputMessageText", text_=text, disable_web_page_preview_=1, clear_draft_=0, entities_={[0] = {ID="MessageEntityMentionName", offset_=0, length_=19, user_id_=id}}}}, dl_cb, nil)
end
--     By Developer IBOIBO     -- 
if text:match("^رابط حذف$") or text:match("^رابط الحذف$") or text:match("^اريد رابط الحذف$") or  text:match("^شمرلي رابط الحذف$") or text:match("^اريد رابط حذف$")
...
--     By Developer IBOIBO     -- 
if text:match("^source$") or text:match("^اصدار$") or text:match("^الاصدار$") or  text:match("^السورس$") or text:match("^سورس$") 
local inline = {
...
--     By Developer IBOIBO     -- 
if text:match("^رسائلي اليوم$") 
local faeder = faederdx1:get(FAEDER..'user:msgs'..bot_id..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙رسائلك اليوم ، *{"..(faeder).."} *", 1, 'md')
end
--     By Developer IBOIBO     -- 
if text:match("^[/!#]([Ww][Ee][Aa][Tt][Hh][Ee][Rr]) (.*)$") or text:match("^(طقس) (.*)$")
...
-------- Set Sudo3
if is_sudo(msg) then
if text ==('رفع مطور رتبه ثالثه') or text ==('رفع مطور') or text ==('اضف مطور')
...
if text and text:match('^رفع مطور رتبه ثالثه @(.*)')
...
--     By Developer IBOIBO     -- 
-------- Rem Sudo3
if text ==('تنزيل مطور رتبه ثالثه') or text ==('تنزيل مطور') or text ==('حذف مطور')
...
if text and text:match('^تنزيل مطور رتبه ثالثه @(.*)')
...
if text and text:match('^رفع مدير عام @(.*)')
...
if text and text:match('^تنزيل مدير عام @(.*)')
...
--     By Developer IBOIBO     -- 
-------- Set Moall
if is_onall(msg.sender_user_id_, msg.chat_id_)
...
if text and text:match('^رفع ادمن عام @(.*)')
...
if text and text:match('^تنزيل ادمن عام @(.*)')
...
if text and text:match('^رفع مميز عام @(.*)')
...
if text and text:match('^تنزيل مميز عام @(.*)')
...
if text and text:match('^رفع منشئ اساسي @(.*)')
...
if text and text:match('^تنزيل منشئ اساسي @(.*)')
...
if text and text:match('^رفع منشئ @(.*)')
...
if text and text:match('^تنزيل منشئ @(.*)')
...
if text and text:match('^رفع مدير @(.*)')
...
if text and text:match('^تنزيل مدير @(.*)')
...
if text and text:match('^رفع ادمن @(.*)')
...
if text and text:match('^تنزيل ادمن @(.*)')
...
if text and text:match('^رفع مميز @(.*)')
...
if text and text:match('^تنزيل مميز @(.*)')
...
--     By Developer IBOIBO     -- 
if text == ("تنزيل الكل") and msg.reply_to_message_id_ ~= 0 and is_owner(msg.sender_user_id_, msg.chat_id_) 
...
--     By Developer IBOIBO     -- 
if text and text:match("^تنزيل الكل @(.*)$") and is_owner(msg.sender_user_id_, msg.chat_id_)
...
--     By Developer IBOIBO     -- 
if text:match("^رفع ادمن بالكروب$")  and is_monsh(msg.sender_user_id_, msg.chat_id_) and msg.reply_to_message_id_
function promote_by_reply(extra, result, success)
local user_info_ = faederdx1:get(FAEDER..'user:Name' .. result.sender_user_id_)
local faeder_res = user_info_
if user_info_ then
...
if text:match("^تنزيل ادمن بالكروب$")  and is_monsh(msg.sender_user_id_, msg.chat_id_) and msg.reply_to_message_id_
function promote_by_reply(extra, result, success)
local user_info_ = faederdx1:get(FAEDER..'user:Name' .. result.sender_user_id_)
local faeder_res = user_info_
if user_info_ then
...
if text:match("^رفع بكل الصلاحيات$")  and is_monsh(msg.sender_user_id_, msg.chat_id_) and msg.reply_to_message_id_
function promote_by_reply(extra, result, success)
local user_info_ = faederdx1:get(FAEDER..'user:Name' .. result.sender_user_id_)
local faeder_res = user_info_
if user_info_ then
...
if text:match("^الغاء خاصيه تغيير الاسم$")  and is_monsh(msg.sender_user_id_, msg.chat_id_) and msg.reply_to_message_id_
function promote_by_reply(extra, result, success)
local user_info_ = faederdx1:get(FAEDER..'user:Name' .. result.sender_user_id_)
local faeder_res = user_info_ 
if user_info_ then
...
if text:match("^الغاء خاصيه التثبيت$")  and is_monsh(msg.sender_user_id_, msg.chat_id_) and msg.reply_to_message_id_
function promote_by_reply(extra, result, success)
local user_info_ = faederdx1:get(FAEDER..'user:Name' .. result.sender_user_id_)
local faeder_res = user_info_ 
if user_info_ then
...
--     By Developer IBOIBO     -- 
if is_momod(msg.sender_user_id_, msg.chat_id_) then
if text:match("^[Dd]el$") or text:match("^مسح$") and msg.reply_to_message_id_ ~= 0
local id = msg.id_
local msgs = {[0] = id}
...
--     By Developer IBOIBO     -- 
if text:match('^حظر @(.*)$') and is_momod(msg.sender_user_id_, msg.chat_id_)
...
--     By Developer IBOIBO     -- 
if text:match("^حظر (%d+)$") and is_momod(msg.sender_user_id_, msg.chat_id_)
...
--     By Developer IBOIBO     -- 
if text:match("^طرد$") and msg.reply_to_message_id_ ~= 0 and is_momod(msg.sender_user_id_, msg.chat_id_)
...
--     By Developer IBOIBO     -- 
if text and text:match("^طرد @(.*)$") and is_momod(msg.sender_user_id_, msg.chat_id_)
...
--     By Developer IBOIBO     -- 
if text:match("^طرد (%d+)$") and is_momod(msg.sender_user_id_, msg.chat_id_)
...
--     By Developer IBOIBO     -- 
if text:match("^الغاء حظر$") and msg.reply_to_message_id_ ~= 0 and is_momod(msg.sender_user_id_, msg.chat_id_)
function faeder(extra, result, success)
...
--     By Developer IBOIBO     -- 
if text:match("^الغاء حظر @(.*)$") and is_momod(msg.sender_user_id_, msg.chat_id_)
...
--     By Developer IBOIBO     -- 
if text:match("^الغاء حظر (%d+)$") and is_momod(msg.sender_user_id_, msg.chat_id_)
...
--     By Developer IBOIBO     -- 
if text:match("^حظر عام$") and is_sudo(msg) and msg.reply_to_message_id_
...
--     By Developer IBOIBO     -- 
if text and text:match("^حظر عام @(.*)$") and is_sudo(msg)
...
--     By Developer IBOIBO     -- 
if text:match("^حظر عام (%d+)$") and is_sudo(msg)
...
--     By Developer IBOIBO     -- 
if text:match("^الغاء العام$") and is_sudo(msg) and msg.reply_to_message_id_
...
--     By Developer IBOIBO     -- 
if text:match("^الغاء العام @(.*)$") and is_sudo(msg)
...
--     By Developer IBOIBO     -- 
if text:match("^الغاء العام (%d+)$") and is_sudo(msg)
...
--     By Developer IBOIBO     -- 
if text:match("^كتم عام$") and is_sudo(msg) and msg.reply_to_message_id_
...
--     By Developer IBOIBO     -- 
if text and text:match("^كتم عام @(.*)$") and is_sudo(msg)
...
--     By Developer IBOIBO     -- 
if text:match("^كتم عام (%d+)$") and is_sudo(msg)
...
--     By Developer IBOIBO     -- 
if text:match("^كتم$") and msg.reply_to_message_id_ ~= 0 and is_momod(msg.sender_user_id_, msg.chat_id_)
...
--     By Developer IBOIBO     -- 
if text:match('^كتم @(.*)$') and is_momod(msg.sender_user_id_, msg.chat_id_)
...
--     By Developer IBOIBO     -- 
if text:match("^كتم (%d+)$") and is_momod(msg.sender_user_id_, msg.chat_id_)
...
--     By Developer IBOIBO     -- 
if text:match("^الغاء كتم$") and msg.reply_to_message_id_ ~= 0 and is_momod(msg.sender_user_id_, msg.chat_id_)
...
--     By Developer IBOIBO     -- 
if text:match("^الغاء كتم @(.*)$") and is_momod(msg.sender_user_id_, msg.chat_id_)
...
--     By Developer IBOIBO     -- 
if text:match("^الغاء كتم (%d+)$") and is_momod(msg.sender_user_id_, msg.chat_id_)
...
if text:match("^تقييد$") or text:match("^تقيد$")  
function mute_by_reply(extra, result, success)
local user_info_ = faederdx1:get(FAEDER..'user:Name' .. result.sender_user_id_)
local faeder_res = user_info_
if user_info_ then
...
--     By Developer IBOIBO     -- 
if msg.reply_to_message_id_ ~= 0 then  
if text:match("^الغاء تقييد$") or text:match("^الغاء تقيد$")
function mute_by_reply(extra, result, success)
local user_info_ = faederdx1:get(FAEDER..'user:Name' .. result.sender_user_id_)
local faeder_res = user_info_
if user_info_ then
...
--     By Developer IBOIBO     -- 
if text and text:match('^كتم د (%d+)$') 
...
--     By Developer IBOIBO     -- 
if text and text:match('^كتم س (%d+)$') 
local function mut_time(extra, result,success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, mut_time,nil) end end 
--     By Developer IBOIBO     -- 
if text and text:match('^كتم ي (%d+)$') 
local function mut_time(extra, result,success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, mut_time,nil) end end 
--     By Developer IBOIBO     -- 
if text == 'مسح المقيدين' and is_momod(msg.sender_user_id_, msg.chat_id_)     
...
--     By Developer IBOIBO     -- 
if text == ("المقيدين") and is_momod(msg.sender_user_id_, msg.chat_id_)  
...
--     By Developer IBOIBO     --  
if text == ("الادمنيه") and is_momod(msg.sender_user_id_, msg.chat_id_)  
...
--     By Developer IBOIBO     -- 
if text == ("المنشئين") and is_monsh(msg.sender_user_id_, msg.chat_id_)  
...
--     By Developer IBOIBO     -- 
if text == ("الادمنيه العامين") and is_admin(msg.sender_user_id_, msg.chat_id_)  
...
--     By Developer IBOIBO     -- 
if text == ("الاعضاء المميزين") and is_momod(msg.sender_user_id_, msg.chat_id_)  
...
--     By Developer IBOIBO     -- 
if text == ("المميزين عام") or text == ("الاعضاء المميزين عام") and is_admin(msg.sender_user_id_, msg.chat_id_)  
...
--     By Developer IBOIBO     -- 
if text == ("المكتومين") and is_momod(msg.sender_user_id_, msg.chat_id_)  
...
--     By Developer IBOIBO     -- 
if text == ("المدراء") and is_monsh2(msg.sender_user_id_, msg.chat_id_)  
...
--     By Developer IBOIBO     -- 
if text == ("المدراء العامين") and is_admin(msg.sender_user_id_, msg.chat_id_)  
...
--     By Developer IBOIBO     --
if text == ("المنشئ") or text == ("المنشئين الاساسيين") or text == ("المنشئ الاساسي") and is_vpall(msg.sender_user_id_, msg.chat_id_)  
...
--     By Developer IBOIBO     --
if text == ("المحظورين") and is_momod(msg.sender_user_id_, msg.chat_id_)  
...
--     By Developer IBOIBO     --
if text == ("قائمه العام") and is_admin(msg.sender_user_id_, msg.chat_id_)  
...
--     By Developer IBOIBO     -- 
if text == ("المطورين") or text == ("مطورين الرتبه الثالثه") and is_admin(msg.sender_user_id_, msg.chat_id_)  
local list = faederdx1:smembers(FAEDER..'bot:admins:')
if #list == 0 then
...
faederdx(msg.chat_id_, msg.id_, 1, text, 1, 'html')
 ...
 --     By Developer IBOIBO     --
 if text == ("المكتومين عام") and is_admin(msg.sender_user_id_, msg.chat_id_)  
...
--     By Developer IBOIBO     -- 
if text and (text == "تفعيل تحويل الصيغ" or text == "تفعيل التحويل") and is_momod(msg.sender_user_id_, msg.chat_id_)  
local faeder = '⌯︙اهلا عزيزي ، '..renk_faeder(msg)..' \n⌯︙تم تفعيل تحويل الصيغ'
faederdx(msg.chat_id_, msg.id_, 1,faeder, 1, 'md') 
faederdx1:del(FAEDER..'bot:Convert'..msg.chat_id_) 
end
if text and (text == "تعطيل تحويل الصيغ" or text == "تعطيل التحويل") and is_momod(msg.sender_user_id_, msg.chat_id_)  
...
--     By Developer IBOIBO     -- 
if text ==("كشف") or text ==("ايدي")  and msg.reply_to_message_id_ ~= 0 
...
--     By Developer IBOIBO     -- 
if is_owner(msg.sender_user_id_, msg.chat_id_) then
if text and text:match("^تغيير الايدي$") and faeder11(msg) or text and text:match("^تغير الايدي$") 
local List = {
[[
゠𝚄𝚂𝙴𝚁 𖨈 #username 𖥲 .
゠𝙼𝚂𝙶 𖨈 #msgs 𖥲 .
...
--     By Developer IBOIBO     -- 
if is_leader(msg) then
if text and text:match("^تعيين الايدي العام$") or text and text:match("^تعين الايدي العام$") or text and text:match("^تعيين كليشة الايدي$") and faeder11(msg) or text and text:match("^تعيين ايدي عام$") and faeder11(msg) or text and text:match("^تعيين الايدي عام$")   
...
--     By Developer IBOIBO     -- 
if text and text:match("^تعيين الايدي$") and faeder11(msg) or text and text:match("^تعين الايدي$")
faederdx(msg.chat_id_, msg.id_, 1, ' \n⌯︙لتعيين كليشه الايدي استخدم الدوال ادناه ،\n         • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ • ┉ •\n- #username  لطبع المعرف\n- #id  لطبع الايدي \n- #photos  لطبع عدد الصور \n- #stast لطبع الرتبه \n- #msgs  لطبع عدد الرسائل \n- #msgday  لطبع الرسائل اليوميه \n- #formsg  لطبع التفاعل \n- #game  لطبع عدد النقاط \n- #cont  لطبع عدد الجهات \n- #sticker  لطبع عدد الملصقات\n', 1, 'md')
...
if text and text:match("^حذف الايدي$") and faeder11(msg) or text and text:match("^مسح الايدي$")
local faeder = '⌯︙اهلا عزيزي  '..renk_faeder(msg)..' \n⌯︙تم حذف كليشة الايدي ،'
faederdx(msg.chat_id_, msg.id_, 1, faeder, 1, 'md')
...
if text and (text:match("^ايدي$") or text:match("^id$") or text:match("^Id$"))
function faeder(extra,result,success)
if result.username_ then username = '@'..result.username_ else username = ' لا يوجد 🎍 ' end
...
--     By Developer IBOIBO     -- 
 if text == "صورتي" and not faederdx1:get(FAEDER.."lock:get:photo"..msg.chat_id_)  
local function getpro(extra, result, success)
if result.photos_[0] then
...
--     By Developer IBOIBO     -- 
if text and text:match("^صورتي (%d+)$")
...
--     By Developer IBOIBO     -- 
if is_momod(msg.sender_user_id_, msg.chat_id_) then 
if text and text:match("^قفل (.*)$") and is_momod(msg.sender_user_id_, msg.chat_id_)
...
--     By Developer IBOIBO     -- 
if (text and text == 'تفعيل الايدي بالصوره') and is_owner(msg.sender_user_id_, msg.chat_id_) or (text and text == 'ضع الايدي بالصوره') and is_owner(msg.sender_user_id_, msg.chat_id_)
if not faederdx1:get('FAEDER:id:photo'..msg.chat_id_) then
...
if (text and text == 'تعطيل الايدي بالصوره') and is_owner(msg.sender_user_id_, msg.chat_id_) or (text and text == 'ضع الايدي بدون صوره') and is_owner(msg.sender_user_id_, msg.chat_id_)
...
faederdx1:set('FAEDER:id:photo'..msg.chat_id_,true)
 ...
 --     By Developer IBOIBO     -- 
if (text and text == 'تفعيل الايدي') and is_owner(msg.sender_user_id_, msg.chat_id_)
if not faederdx1:get('FAEDER:id:mute'..msg.chat_id_) then
...
if (text and text == 'تعطيل الايدي') and is_owner(msg.sender_user_id_, msg.chat_id_)
...
faederdx1:set('FAEDER:id:mute'..msg.chat_id_,true)
 ...
 if (text and text == 'تفعيل اللعبه') and is_momod(msg.sender_user_id_, msg.chat_id_) and faeder11(msg) or (text and text == 'تفعيل الالعاب') and is_momod(msg.sender_user_id_, msg.chat_id_)
...
if (text and text == 'تعطيل اللعبه') and is_momod(msg.sender_user_id_, msg.chat_id_) and faeder11(msg) or (text and text == 'تعطيل الالعاب') and is_momod(msg.sender_user_id_, msg.chat_id_)
if faederdx1:get(FAEDER..'bot:lock_geam'..msg.chat_id_) then
...
faederdx1:set(FAEDER..'bot:lock_geam'..msg.chat_id_,true)
 ...
 if (text and text == 'تفعيل تاك الكل') and is_momod(msg.sender_user_id_, msg.chat_id_)
...
if (text and text == 'تعطيل تاك الكل') and is_momod(msg.sender_user_id_, msg.chat_id_)
...
if text and text:match("^ضع ترحيب$") and faeder11(msg) or text and text:match("^وضع ترحيب$")
...
if text and text:match("^حذف الترحيب$") and faeder11(msg) or text and text:match("^مسح الترحيب$")
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙تم حذف الترحيب ، ', 1, 'md')
faederdx1:del(FAEDER..'get:welcome'..msg.chat_id_)
end
if text and text:match("^جلب الترحيب$") and faeder11(msg) or text and text:match("^الترحيب$")
...
if text and text:match("^ضع قوانين$") and faeder11(msg) or text and text:match("^وضع قوانين$")
...
if text and text:match("^ضع وصف$") and faeder11(msg) or text and text:match("^وضع وصف$")  
...
--     By Developer IBOIBO     -- 
if is_momod(msg.sender_user_id_, msg.chat_id_) then
if text == "تنظيف ميديا" or text == "تنظيف الميديا"   
faeder = {[0]= msg.id_}
...
--     By Developer IBOIBO     -- 
if is_momod(msg.sender_user_id_, msg.chat_id_) then
if text and text:match("^قفل الكل بالساعات (%d+)$")
...
if text and text:match("^مسح القوائم$")
if not is_monsh(msg.sender_user_id_, msg.chat_id_) then
...
--     By Developer IBOIBO     -- 
if text and text:match("^تفعيل الحمايه القصوى$") or text:match("^قفل التفليش$")
if not is_monsh(msg.sender_user_id_, msg.chat_id_) then
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙هذه الخاصيه للمنشئ والرتب الاعلى منه ، ', 1, 'md')
else
faederdx1:set(FAEDER..'bot:links:mute'..msg.chat_id_,true)
...
--     By Developer IBOIBO     -- 
if is_momod(msg.sender_user_id_, msg.chat_id_) then
if text and text:match("^الاعدادات$")
...
--     By Developer IBOIBO     -- 
if (text and text == 'تفعيل ردود البوت') and is_owner(msg.sender_user_id_, msg.chat_id_)
...
if (text and text == 'تعطيل ردود البوت') and is_owner(msg.sender_user_id_, msg.chat_id_)
...
--     By Developer IBOIBO     -- 
if is_momod(msg.sender_user_id_, msg.chat_id_) then
if text and text:match("^الروابط$")
if faederdx1:get(FAEDER..'bot:links:mute'..msg.chat_id_) then
mute_links = 'مقفوله 🌟'
else
mute_links = 'معطل 🛢'
...
--     By Developer IBOIBO     -- 
if text and text:match("^ضع صوره$") and is_owner(msg.sender_user_id_, msg.chat_id_)
...
--     By Developer IBOIBO     -- 
if text and text:match("^طرد الحسابات المحذوفه$") and faeder11(msg) or text and text:match("^طرد المحذوف$")
...
--     By Developer IBOIBO     -- 
if text and text:match("^تنظيف قائمه الحظر$")
...
--     By Developer IBOIBO     -- 
if text and text:match("^مسح المحظورين$")
local function removeblocklist(extra, result)
if tonumber(result.total_count_) == 0 then 
...
--     By Developer IBOIBO     -- 
if text and text:match("^معلومات المجموعه$")
...
--     By Developer IBOIBO     -- 
if text == 'تفعيل ضافني' and is_owner(msg.sender_user_id_, msg.chat_id_)
local faeder = '⌯︙اهلا عزيزي ، '..renk_faeder(msg)..' \n⌯︙تم تفعيل منو ضافني'
faederdx( msg.chat_id_, msg.id_, 1, faeder, 1, "md") 
faederdx1:del(FAEDER..'Added:Me'..msg.chat_id_) 
end
if text == 'تعطيل ضافني' and is_owner(msg.sender_user_id_, msg.chat_id_)
local faeder = '⌯︙اهلا عزيزي ، '..renk_faeder(msg)..' \n⌯︙تم تعطيل منو ضافني'
faederdx( msg.chat_id_, msg.id_, 1, faeder, 1, "md") 
...
if text and text == "تفعيل تنبيه التغيرات"
...
if text and text == "تعطيل تنبيه التغيرات" 
if not is_owner(msg.sender_user_id_, msg.chat_id_) then
faederdx(msg.chat_id_, msg.id_, 1, '⌯︙لمدراء المجموعه فما فوق ', 1, 'md')
else 
...
--     By Developer IBOIBO     -- 
if text == 'تفعيل جلب الصوره' and is_owner(msg.sender_user_id_, msg.chat_id_)   
...
if text == 'تعطيل جلب الصوره' and is_owner(msg.sender_user_id_, msg.chat_id_)   
...
--     By Developer IBOIBO     -- 
if text and text:match('^تعطيل$') and is_monsh(msg.sender_user_id_, msg.chat_id_)
...
--     By Developer IBOIBO     -- 
if text and text:match("^تفعيل كل الكروبات$")
...
if text and text:match("^تعطيل كل الكروبات$")
local gps = faederdx1:smembers(FAEDER.."bot:groups") or 0
local gps2 = faederdx1:smembers("faeder:addg"..bot_id) or 0
for i=1,#gps do
...
--     By Developer IBOIBO     -- 
if text and text:match("^الدعم$") or text:match("^المطور$")
function adding(extra,result,success)
function faeder(f1,f2)
function faeder333(t1,t2)
if t2.invite_link_ == false then 
...
--     By Developer IBOIBO     --  
text = msg.content_.text_
if msg.content_.text_ == 'حذف رد' and is_owner(msg.sender_user_id_, msg.chat_id_) and faeder11(msg) or msg.content_.text_ == 'مسح رد' and  is_owner(msg.sender_user_id_, msg.chat_id_)
...
return false end end
--     By Developer IBOIBO     -- 
if msg.content_.text_ == 'اضف رد' and is_owner(msg.sender_user_id_, msg.chat_id_)
...
--     By Developer IBOIBO     -- 
if msg.content_.text_ == 'الردود' and is_owner(msg.sender_user_id_, msg.chat_id_) and faeder11(msg) or msg.content_.text_ == 'ردود المدير' and is_owner(msg.sender_user_id_, msg.chat_id_)
...
--     By Developer IBOIBO     -- 
if is_momod(msg.sender_user_id_, msg.chat_id_) then
if text and text:match('^تنظيف (%d+)$')    
...
--     By Developer IBOIBO     -- 
if text:match("^م1$") or  text:match("^م١$") 
...
--     By Developer IBOIBO     -- 
if is_leader(msg) and text:match("^تعيين امر م2$")
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙ارسل لي الكليشه الان " ,  1, "md")
...
--     By Developer IBOIBO     -- 
if text:match("^م2$") or text:match("^م٢$")
...
--     By Developer IBOIBO     -- 
if is_leader(msg) and text:match("^تعيين امر م3$")
faederdx(msg.chat_id_, msg.id_, 1, "⌯︙ارسل لي الكليشه الان " ,  1, "md")
...
--     By Developer IBOIBO     -- 
if text:match("^م3$") or text:match("^م٣$")
...
--     By Developer IBOIBO     -- 
if text:match("^م٤$") or text:match("^م4$")
...
--     By Developer IBOIBO     -- 
if text:match("^م٥$") or text:match("^م5$")
...
--     By Developer IBOIBO     -- 
if text:match("^م٦$") or text:match("^م6$")
...
--     By Developer IBOIBO     -- 
if text:match("^م٧$") or text:match("^م7$")
...
--     By Developer IBOIBO     -- 
if text:match("^م٨$") or text:match("^م8$")
...
os.execute('wget https://raw.githubusercontent.com/IBOIBO99/IBO/master/FAEDER.lua') 
...
--     By Developer IBOIBO     -- 
if text and text:match("^اضف رسائل (%d+)$") and is_monsh(msg.sender_user_id_, msg.chat_id_)  
